...
class _objref_BiasModuleCorba (CORBA.Object):
    ...
    __methods__ = ["getTemperature", "getMagnetCurrent", "getMagnetVoltage", "getSISVoltage", "getSISCurrent", "getLNADrainVoltage", "getLNADrainCurrent", "getLNAGateVoltage", "setMagnetCurrent"] + CORBA.Object.__methods__
